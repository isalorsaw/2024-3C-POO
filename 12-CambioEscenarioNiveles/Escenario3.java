...
public class Escenario3 extends JPanel implements KeyListener,ActionListener,MouseListener//Implementar los eventos de tecla
{
    Fondo f;
    Nave n;
    //Piedra pi;
